...
%(originally in 2017a Windows 7 adusted to matlab 2019/R2019b)
...
for k = 1:length(filenames)
    ...
    [maxThree, MinofMax, minfa, AvMax, StDmax]=IRT_plot_min_max_automatic_1(maxeye, mineye, myfilepath, filename, filenames, auto_semi);   
   % if HighestFrameNr > 1      
